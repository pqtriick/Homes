...
public enum MessageEnum {
    ...
    TELEPORT_ACTIONBAR("messages.teleport_actionbar", "§6Teleporting in §e%seconds% §6seconds!"),
    TELPORT_ACTIONBAR_CANCEL("messages.teleport_actionbar_cancel", "§cTeleporting to home cancelled because you moved!"),

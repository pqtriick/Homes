...
public class Options {
    ...
    public static void initOptionsFile() {
        if (!optionsfile.exists()) {
            ...
            optionsconfig.set("options.homerank.enabled", "true");
            optionsconfig.set("options.homerank.defaultsize", "20");
            optionsconfig.set("options.homes.rank_player.maxsize", "20");
